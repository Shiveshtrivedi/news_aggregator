...
namespace news_aggregator.infrastructure.Migrations
{
    ...
    [Migration("20250617140545_MakingNotificationScalable")]
    partial class MakingNotificationScalable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("news_application.Models.ExternalSource", b =>
                {
                    ...
                    b.Property<string>("PublishedAtPath")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RootListPath")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
