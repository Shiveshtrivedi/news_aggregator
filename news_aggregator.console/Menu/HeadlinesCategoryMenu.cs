...
namespace news_aggregator.console.Menu
{
    public class HeadlinesCategoryMenu : IMenu
    {
        ...
        public HeadlinesCategoryMenu(string userName, DateTime startDate, DateTime endDate,
            ICategoryService categoryService, INewsArticleService newsService, ISavedArticleService savedArticleService)
        {
            _userName = userName;
        ...
        public async Task Show()
        {
            while (true)
            {
                ...
                try
                {
                    ...
                    catch (NewsArticleFetchException ex)
                    {
                        Console.WriteLine($"Error while fetching news: {ex.Message}");
                        Console.ReadKey();
                    }
                }
                catch (Exception ex)
